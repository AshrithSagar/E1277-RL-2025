...
The in-place version alternates between the policy evaluation and policy improvement steps for single states.
...
The process of updating the estimate of the value of a state based on the estimates of the values of its successor states.
