...
$$
\left( \frac{\underline\beta}{1 - \alpha} e \right) \leq \bar g_\mu + \left( \frac{\alpha \underline\beta}{1 - \alpha} \right) e \leq J_\mu \leq \bar g_\mu + \left( \frac{\alpha \bar\beta}{1 - \alpha} \right) e \leq \left( \frac{\bar\beta}{1 - \alpha} e \right)
$$
...
$$
\left( \frac{\underline\gamma}{1 - \alpha} e \right) \leq T_\mu J - J + \left( \frac{\alpha \underline\gamma}{1 - \alpha} \right) e \leq J^\mu - J \leq T_\mu J - J + \left( \frac{\alpha \bar\gamma}{1 - \alpha} \right) e \leq \left( \frac{\bar\gamma}{1 - \alpha} e \right)
$$
where
$$
\begin{aligned}
...
$$
J + \left( \frac{\underline\gamma}{1 - \alpha} e \right) \leq T_\mu J + \left( \frac{\alpha \underline\gamma}{1 - \alpha} \right) e \leq J^\mu \leq T_\mu J + \left( \frac{\alpha \bar\gamma}{1 - \alpha} \right) e \leq J + \left( \frac{\bar\gamma}{1 - \alpha} e \right)
$$
